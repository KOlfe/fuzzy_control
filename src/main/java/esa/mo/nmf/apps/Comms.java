...
public static void setPortNumber(int port_number, int sc_number){
...
public static void read42(){
    try {
       ...
       PosN = new Vector3D(Double.parseDouble(pos[2]), Double.parseDouble(pos[3]), Double.parseDouble(pos[4]));
